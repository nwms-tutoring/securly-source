...
!(function (e, t) {
                          ...
                          (ce(function (e) {
                              ...
                              (h.appendChild(e).innerHTML =
                                  ...
                                  e.querySelectorAll("[msallowcapture^='']").length &&
                                      y.push("[*^$]=" + R + "*(?:''|\"\")"),
                                  e.querySelectorAll("[selected]").length || y.push("\\[" + R + "*(?:value|" + O + ")"),
                ...
                function (e, t, n, i) {
                    ...
                    if (((n = n || []), 1 === d.length)) {
                        ...
                        for (
                            ...
                            if (
                                (f = r.find[c]) &&
                                (i = f(l.matches[0].replace(te, ne), (ee.test(u[0].type) && ve(t.parentNode)) || t))
                            ) {
            ...
            function (e, t) {
                b.fn[e] = function (n, r) {
                    ...
                    return (
                        ...
                        this.length > 1 && (q[e] || b.uniqueSort(i), L.test(e) && i.reverse()),
                        this.pushStack(i)
                    );
                };
            }
    ...
    (b.Callbacks = function (e) {
        ...
        b.extend({
            ...
            when: function (e) {
                ...
                if (
                    t <= 1 &&
                    (R(e, a.done(s(n)).resolve, a.reject, !t), "pending" === a.state() || h(o[n] && o[n].then))
                )
                    return a.then();
        ...
        b.extend({
            ...
            ready: function (e) {
                (!0 === e ? --b.readyWait : b.isReady) ||
                    ((b.isReady = !0), (!0 !== e && --b.readyWait > 0) || B.resolveWith(y, [b]));
            },
        }),
        (b.ready.then = B.then),
            ...
            queue: function (e, t, n) {
                ...
                if (e)
                    return (
                        (t = (t || "fx") + "queue"),
                        (r = X.get(e, t)),
                        n && (!r || Array.isArray(n) ? (r = X.access(e, t, b.makeArray(n))) : r.push(n)),
                        r || []
                    );
            },
            ...
            if (y && (u = y.events)) {
                for (l = (t = (t || "").match(M) || [""]).length; l--; )
                    if (((d = g = (s = be.exec(t[l]) || [])[1]), (h = (s[2] || "").split(".").sort()), d)) {
                        ...
                        a &&
                            !p.length &&
                            ((f.teardown && !1 !== f.teardown.call(e, h, y.handle)) || b.removeEvent(e, d, y.handle),
                            delete u[d]);
                ...
                for (a = b.event.handlers.call(this, u, l), t = 0; (i = a[t++]) && !u.isPropagationStopped(); )
                    for (u.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !u.isImmediatePropagationStopped(); )
                        (u.rnamespace && !1 !== o.namespace && !u.rnamespace.test(o.namespace)) ||
                            ...
                            (u.data = o.data),
                            void 0 !==
                                (r = ((b.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s)) &&
                                !1 === (u.result = r) &&
    ...
    function He(e, t, n, r) {
        ...
        if (
            ...
            for (u = (s = b.map(ye(i, "script"), Ne)).length; f < p; f++)
                (l = i), f !== g && ((l = b.clone(l, !0, !0)), u && b.merge(s, ye(l, "script"))), n.call(e[f], l, f);
            if (u)
    ...
    b.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n) for (o = o || ye(e), a = a || ye(c), r = 0, i = o.length; r < i; r++) qe(o[r], a[r]);
                else qe(e, c);
            ...
            "margin" === n && (u += b.css(e, n + te[a], !0, i)),
                r
                    ? ("content" === n && (u -= b.css(e, "padding" + te[a], !0, i)),
                      "margin" !== n && (u -= b.css(e, "border" + te[a] + "Width", !0, i)))
            ...
            b.cssHooks[t] = {
                ...
                set: function (e, n, r) {
                    ...
                    return (
                        ...
                        u && (i = ee.exec(n)) && "px" !== (i[3] || "px") && ((e.style[t] = n), (n = b.css(e, t))),
                        Ye(0, n, u)
                    );
                },
            };
        ...
        (Ke.propHooks = {
            _default: {
                ...
                set: function (e) {
                    b.fx.step[e.prop]
                        ? b.fx.step[e.prop](e)
                        : 1 !== e.elem.nodeType || (!b.cssHooks[e.prop] && null == e.elem.style[Ge(e.prop)])
                          ? (e.elem[e.prop] = e.now)
        ...
        prefilters: [
            function (e, t, n) {
                ...
                if ((u = !b.isEmptyObject(t)) || !b.isEmptyObject(d))
                    ...
                    d))
                        u ||
                            (y ? "hidden" in y && (g = y.hidden) : (y = X.access(e, "fxshow", { display: l })),
                            o && (y.hidden = !g),
                            g && le([e], !0),
                            p.done(function () {
                ...
                return (
                    ...
                    this.each(function () {
                        var t,
                            ...
                            a = r ? r.length : 0;
                        for (
                            n.finish = !0, b.queue(this, e, []), i && i.stop && i.stop.call(this, !0), t = o.length;
                            t--;
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                    return void 0 === e.getAttribute
                        ? b.prop(e, t, n)
                        : ((1 === o && b.isXMLDoc(e)) ||
                              (i = b.attrHooks[t.toLowerCase()] || (b.expr.match.bool.test(t) ? ut : void 0)),
                          void 0 !== n
                              ? null === n
            ...
            if (
                ...
                for (o = 0; (a = v[o++]) && !t.isPropagationStopped(); )
                    (d = a),
                        ...
                        (f = (X.get(a, "events") || Object.create(null))[t.type] && X.get(a, "handle")) &&
                            f.apply(a, n),
                        (f = l && a[l]) &&
                            f.apply &&
                            U(a) &&
    ...
    (Pt.href = mt.href),
        b.extend({
            ...
            ajax: function (t, n) {
                ...
                if (
                    (v.promise(E),
                    (d.url = ((t || d.url || mt.href) + "").replace(Lt, mt.protocol + "//")),
                    ...
                    try {
                        (u.href = d.url),
                            (u.href = u.href),
                            (d.crossDomain = Pt.protocol + "//" + Pt.host != u.protocol + "//" + u.host);
                    } catch (e) {
                        d.crossDomain = !0;
                    }
                }
                ...
                d.hasContent
                    ...
                    : ((p = d.url.slice(i.length)),
                      ...
                      !1 === d.cache &&
                          ((i = i.replace(kt, "$1")), (p = (bt.test(i) ? "&" : "?") + "_=" + xt.guid++ + p)),
                      (d.url = i + p)),
                d.ifModified &&
                ...
                function S(t, n, a, u) {
                    ...
                    l ||
                        ...
                        f
                            ? (d.ifModified &&
                                  ((C = E.getResponseHeader("Last-Modified")) && (b.lastModified[i] = C),
                                  (C = E.getResponseHeader("etag")) && (b.etag[i] = C)),
                              204 === t || "HEAD" === d.type
                                  ? (T = "nocontent")
                                  : 304 === t
                                    ? (T = "notmodified")
                        ...
                        (E.status = t),
                        (E.statusText = (n || T) + ""),
                        f ? v.resolveWith(h, [p, T, E]) : v.rejectWith(h, [E, T, y]),
                        E.statusCode(x),
                        (x = void 0),
                        c && g.trigger(f ? "ajaxSuccess" : "ajaxError", [E, d, f ? p : y]),
                        m.fireWith(h, [E, T]),
                        c && (g.trigger("ajaxComplete", [E, d]), --b.active || b.event.trigger("ajaxStop")));
                }
                return E;
            },
    ...
    b.ajaxSetup({
            ...
            if (s || "jsonp" === t.dataTypes[0])
                return (
                    ...
                    s
                        ...
                        : !1 !== t.jsonp && (t.url += (bt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
        ...
        (d.createHTMLDocument =
            (((Ft = y.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"),
        ...
        (b.parseHTML = function (e, t, n) {
            return "string" != typeof e
                ...
                : ("boolean" == typeof t && ((n = t), (t = !1)),
                  ...
                  i
                      ? [t.createElement(i[1])]
                      : ((i = xe([e], t, o)), o && o.length && b(o).remove(), b.merge([], i.childNodes)));
            var r, i, o;
        }),
    ...
    function n(e, t) {
        ...
        i.length > 0
            ...
            : (i = [...n.matchAll(regexGriefArray)]).length > 0
              ? r(e, i, "Grief", t)
              : (i = [...n.matchAll(regexViolenceArray)]).length > 0 && r(e, i, "Violence", t);
    }
    function r(e, t, n, r) {
        const i = [];
        let o = [];
        jqGCSecurly(r.currentTarget)
            ...
            (function (e, t, n, r, i) {
                let o = t
                    .map((e) => phraseMatchList[i].find((t) => t.Phrase.toLowerCase() == e))
                    .filter((e) => void 0 !== e);
                var a = {};
                (a.chatRoomId = gChatId),
                    ...
                    (a.type_detail = i),
                    (a.chatMembers = n),
                    gChatPort.postMessage({ action: "sendGoogleChatAnaltics", data: JSON.stringify(a) });
            })(
                e,
                t,
                (o = o.filter(
                    (e, t, n) => n.findIndex((t) => ["displayname", "userEmail"].every((n) => t[n] === e[n])) === t
                )),
                i.reverse(),
                n
            );
