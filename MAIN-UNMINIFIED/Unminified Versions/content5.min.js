...
!(function (e, t) {
                            ...
                            (r = e[t]),
                                "__proto__" !== t &&
                                    ...
                                    (l && r && (b.isPlainObject(r) || (o = Array.isArray(r)))
                                        ? ((n = a[t]),
                                          (i = o && !Array.isArray(n) ? [] : o || b.isPlainObject(n) ? n : {}),
                                          (o = !1),
                                          (a[t] = b.extend(l, i, r)))
                                        : void 0 !== r && (a[t] = r));
                return a;
        ...
        b.extend({
            ...
            isPlainObject: function (e) {
                ...
                return (
                    ...
                    (!(t = r(e)) ||
                        ("function" == typeof (n = c.call(t, "constructor") && t.constructor) && f.call(n) === d))
                );
            },
                    ...
                    if (((m = e), (v = t), 1 === w && (U.test(e) || $.test(e)))) {
                        for (
                            ((v = (ee.test(e) && me(t.parentNode)) || t) === t && n.scope) ||
                                ((c = t.getAttribute("id")) ? (c = c.replace(re, oe)) : t.setAttribute("id", (c = b))),
                                s = (h = a(e)).length;
                            s--;
                                          ...
                                          for (
                                              x =
                                                  (p =
                                                      (l =
                                                          (c =
                                                              (f = (d = y)[b] || (d[b] = {}))[d.uniqueID] ||
                                                              (f[d.uniqueID] = {}))[e] || [])[0] === S && l[1]) && l[2],
                                                  d = p && y.childNodes[p];
                ...
                function (e, t, n, o) {
                    ...
                    if (((n = n || []), 1 === p.length)) {
                        ...
                        for (
                            ...
                            if (
                                (f = r.find[c]) &&
                                (o = f(l.matches[0].replace(te, ne), (ee.test(u[0].type) && me(t.parentNode)) || t))
                            ) {
    ...
    ((b.fn.init = function (e, t, n) {
        ...
        if (((n = n || A), "string" == typeof e)) {
            if (
                !(r = "<" === e[0] && ">" === e[e.length - 1] && e.length >= 3 ? [null, e, null] : N.exec(e)) ||
                (!r[1] && t)
            )
            ...
            if (r[1]) {
                if (
                    ...
                    b.merge(this, b.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : y, !0)),
            ...
            if (!q.test(e))
                for (; r < o; r++)
                    for (n = this[r]; n && n !== t; n = n.parentNode)
                        if (
                            n.nodeType < 11 &&
                            (a ? a.index(n) > -1 : 1 === n.nodeType && b.find.matchesSelector(n, e))
                        ) {
                            i.push(n);
                            break;
                        }
        ...
        b.each(
            {
                ...
                contents: function (e) {
                    return null != e.contentDocument && r(e.contentDocument)
                        ? e.contentDocument
                        : (C(e, "template") && (e = e.content || e), b.merge([], e.childNodes));
                },
            },
            function (e, t) {
                b.fn[e] = function (n, r) {
                    ...
                    return (
                        ...
                        this.length > 1 && (L[e] || b.uniqueSort(o), D.test(e) && o.reverse()),
                        this.pushStack(o)
                    );
                };
            }
    ...
    (b.Callbacks = function (e) {
        ...
        b.extend({
                        ...
                        then: function (t, r, o) {
                            ...
                            function a(t, n, r, o) {
                                return function () {
                                        ...
                                        l = function () {
                                            ...
                                            if (!(t < i)) {
                                                ...
                                                (l = e && ("object" == typeof e || "function" == typeof e) && e.then),
                                                    h(l)
                                                        ? o
                                                            ? l.call(e, a(i, n, R, o), a(i, n, M, o))
                                                            : (i++,
                                                              l.call(
                                                                  e,
                                                                  a(i, n, R, o),
                                                                  a(i, n, M, o),
                                                                  a(i, n, R, n.notifyWith)
                                                              ))
                                                        : (r !== R && ((s = void 0), (u = [e])),
                                                          (o || n.resolveWith)(s, u));
                                            }
                                    ...
                                    t
                                        ? c()
                                        : (b.Deferred.getStackHook && (c.stackTrace = b.Deferred.getStackHook()),
                                          e.setTimeout(c));
                                };
                            }
                            return b
            ...
            when: function (e) {
                ...
                if (
                    t <= 1 &&
                    (P(e, a.done(s(n)).resolve, a.reject, !t), "pending" === a.state() || h(i[n] && i[n].then))
                )
                    return a.then();
        ...
        b.extend({
            ...
            ready: function (e) {
                (!0 === e ? --b.readyWait : b.isReady) ||
                    ((b.isReady = !0), (!0 !== e && --b.readyWait > 0) || W.resolveWith(y, [b]));
            },
        }),
        (b.ready.then = W.then),
        "complete" === y.readyState || ("loading" !== y.readyState && !y.documentElement.doScroll)
            ? e.setTimeout(b.ready)
            : (y.addEventListener("DOMContentLoaded", z), e.addEventListener("load", z));
    ...
    var ie = function (e, t) {
        return (
            "none" === (e = t || e).style.display || ("" === e.style.display && re(e) && "none" === b.css(e, "display"))
        );
    };
    function ae(e, t, n, r) {
        var o,
        ...
        if (c && c[3] !== l) {
            for (u /= 2, l = l || c[3], c = +u || 1; a--; )
                b.style(e, t, c + l), (1 - i) * (1 - (i = s() / u || 0.5)) <= 0 && (a = 0), (c /= i);
                  ...
                  handler: function (e) {
                      ...
                      if (1 & e.isTrigger && this[t]) {
                          if (a.length) (b.event.special[t] || {}).delegateType && e.stopPropagation();
                              ...
                              (r = n(this, t)),
                              this[t](),
                              a !== (i = G.get(this, t)) || r ? G.set(this, t, !1) : (i = {}),
                              a !== i)
                          )
            ...
            if (y && (u = y.events)) {
                for (l = (t = (t || "").match(H) || [""]).length; l--; )
                    if (((p = g = (s = be.exec(t[l]) || [])[1]), (h = (s[2] || "").split(".").sort()), p)) {
                        ...
                        a &&
                            !d.length &&
                            ((f.teardown && !1 !== f.teardown.call(e, h, y.handle)) || b.removeEvent(e, p, y.handle),
                            delete u[p]);
                ...
                for (a = b.event.handlers.call(this, u, l), t = 0; (o = a[t++]) && !u.isPropagationStopped(); )
                    for (u.currentTarget = o.elem, n = 0; (i = o.handlers[n++]) && !u.isImmediatePropagationStopped(); )
                        (u.rnamespace && !1 !== i.namespace && !u.rnamespace.test(i.namespace)) ||
                            ...
                            (u.data = i.data),
                            void 0 !==
                                (r = ((b.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, s)) &&
                                !1 === (u.result = r) &&
                    ...
                    if (1 === l.nodeType && ("click" !== e.type || !0 !== l.disabled)) {
                        for (i = [], a = {}, n = 0; n < u; n++)
                            void 0 === a[(o = (r = t[n]).selector + " ")] &&
                                (a[o] = r.needsContext ? b(o, this).index(l) > -1 : b.find(o, this, null, [l]).length),
                                a[o] && i.push(r);
            ...
            e && e.type
                ? ((this.originalEvent = e),
                  ...
                  (this.isDefaultPrevented =
                      e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? we : Se),
    ...
    function Oe(e, t, n, r) {
        ...
        var o,
            ...
            y = t[0],
            m = h(y);
        if (m || (d > 1 && "string" == typeof y && !p.checkClone && Ee.test(y)))
        ...
        if (
            d &&
            ((a = (o = xe(t, e[0].ownerDocument, !1, e, r)).firstChild), 1 === o.childNodes.length && (o = a), a || r)
        ) {
            for (u = (s = b.map(ye(o, "script"), Ne)).length; f < d; f++)
                (l = o), f !== g && ((l = b.clone(l, !0, !0)), u && b.merge(s, ye(l, "script"))), n.call(e[f], l, f);
            if (u)
                    ...
                    (l = s[f]),
                        he.test(l.type || "") &&
                            ...
                            (l.src && "module" !== (l.type || "").toLowerCase()
                                ? b._evalUrl &&
                                  !l.noModule &&
                                  b._evalUrl(l.src, { nonce: l.nonce || l.getAttribute("nonce") }, c)
                                : v(l.textContent.replace(ke, ""), l, c));
        }
        return e;
    }
    function He(e, t, n) {
    ...
    b.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n) for (i = i || ye(e), a = a || ye(c), r = 0, o = i.length; r < o; r++) Le(i[r], a[r]);
                else Le(e, c);
                ...
                return _(
                    ...
                    function (e) {
                        ...
                        if ("string" == typeof e && !Ce.test(e) && !ge[(pe.exec(e) || ["", ""])[1].toLowerCase()]) {
                            ...
                            try {
                                for (; n < r; n++)
                                    1 === (t = this[n] || {}).nodeType && (b.cleanData(ye(t, !1)), (t.innerHTML = e));
                                t = 0;
                            } catch (e) {}
                        }
            ...
            function (e, t) {
                b.fn[e] = function (e) {
                    for (var n, r = [], o = b(e), i = o.length - 1, s = 0; s <= i; s++)
                        (n = s === i ? this : this.clone(!0)), b(o[s])[t](n), a.apply(r, n.get());
    ...
    function We(e, t, n) {
        ...
        return (
            (n = n || Me(e)) &&
                ("" !== (a = n.getPropertyValue(t) || n[t]) || re(e) || (a = b.style(e, t)),
                !p.pixelBoxStyles() &&
                    Re.test(a) &&
                    Ie.test(t) &&
                    ((r = s.width),
            ...
            "margin" === n && (u += b.css(e, n + te[a], !0, o)),
                r
                    ? ("content" === n && (u -= b.css(e, "padding" + te[a], !0, o)),
                      "margin" !== n && (u -= b.css(e, "border" + te[a] + "Width", !0, o)))
    ...
    function Ke(e, t, n) {
        ...
        return (
            ((!p.boxSizingReliable() && o) ||
                ...
                ((o = "border-box" === b.css(e, "boxSizing", !1, r)), (i = s in e) && (a = e[s])),
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" === (i = typeof n) && (o = ee.exec(n)) && o[1] && ((n = ae(e, t, o)), (i = "number")),
                    null != n &&
                        n == n &&
                        ("number" !== i || u || (n += (o && o[3]) || (b.cssNumber[s] ? "" : "px")),
            ...
            b.cssHooks[t] = {
                ...
                set: function (e, n, r) {
                    ...
                    return (
                        ...
                        u && (o = ee.exec(n)) && "px" !== (o[3] || "px") && ((e.style[t] = n), (n = b.css(e, t))),
                        Ye(0, n, u)
                    );
                },
            };
        ...
        (Je.propHooks = {
            _default: {
                ...
                set: function (e) {
                    b.fx.step[e.prop]
                        ? b.fx.step[e.prop](e)
                        : 1 !== e.elem.nodeType || (!b.cssHooks[e.prop] && null == e.elem.style[$e(e.prop)])
                          ? (e.elem[e.prop] = e.now)
    ...
    function rt() {
        et &&
            (!1 === y.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(rt) : e.setTimeout(rt, b.fx.interval),
            b.fx.tick());
    }
    function ot() {
        return (
            ...
            function (e, t, n) {
                ...
                if ((u = !b.isEmptyObject(t)) || !b.isEmptyObject(p))
                    for (r in (f &&
                        ...
                        null == (l = y && y.display) && (l = G.get(e, "display")),
                        "none" === (c = b.css(e, "display")) &&
                            (l
                                ? (c = l)
                                : (le([e], !0), (l = e.style.display || l), (c = b.css(e, "display")), le([e]))),
                    ...
                    p))
                        u ||
                            (y ? "hidden" in y && (g = y.hidden) : (y = G.access(e, "fxshow", { display: l })),
                            i && (y.hidden = !g),
                            g && le([e], !0),
                            d.done(function () {
                ...
                return (
                    ...
                    this.each(function () {
                        var t,
                            ...
                            a = r ? r.length : 0;
                        for (
                            n.finish = !0, b.queue(this, e, []), o && o.stop && o.stop.call(this, !0), t = i.length;
                            t--;
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== i && 8 !== i && 2 !== i)
                    return void 0 === e.getAttribute
                        ? b.prop(e, t, n)
                        : ((1 === i && b.isXMLDoc(e)) ||
                              (o = b.attrHooks[t.toLowerCase()] || (b.expr.match.bool.test(t) ? ut : void 0)),
                          void 0 !== n
                              ? null === n
    ...
    b.fn.extend({
        ...
        b.extend({
            prop: function (e, t, n) {
                ...
                if (3 !== i && 8 !== i && 2 !== i)
                    return (
                        (1 === i && b.isXMLDoc(e)) || ((t = b.propFix[t] || t), (o = b.propHooks[t])),
                        void 0 !== n
                            ? o && "set" in o && void 0 !== (r = o.set(e, n, t))
                                ? r
                                : (e[t] = n)
                ...
                select: {
                    ...
                    set: function (e, t) {
                        for (var n, r, o = e.options, i = b.makeArray(t), a = o.length; a--; )
                            ((r = o[a]).selected = b.inArray(b.valHooks.option.get(r), i) > -1) && (n = !0);
    ...
    b.extend(b.event, {
        trigger: function (t, n, r, o) {
            ...
            if (
                ...
                3 !== r.nodeType &&
                    8 !== r.nodeType &&
                    !yt.test(v + b.event.triggered) &&
                    (v.indexOf(".") > -1 && ((v = (x = v.split(".")).shift()), x.sort()),
                    (l = v.indexOf(":") < 0 && "on" + v),
                    ((t = t[b.expando] ? t : new b.Event(v, "object" == typeof t && t)).isTrigger = o ? 2 : 3),
                    (t.namespace = x.join(".")),
                ...
                if (!o && !d.noBubble && !g(r)) {
                    for (u = d.delegateType || v, yt.test(u + v) || (a = a.parentNode); a; a = a.parentNode)
                        m.push(a), (s = a);
                ...
                for (i = 0; (a = m[i++]) && !t.isPropagationStopped(); )
                    (p = a),
                        ...
                        (f = (G.get(a, "events") || Object.create(null))[t.type] && G.get(a, "handle")) &&
                            f.apply(a, n),
                        (f = l && a[l]) &&
                            f.apply &&
                            X(a) &&
                ...
                return (
                    ...
                    o ||
                        ...
                        (l &&
                            ...
                            ((s = r[l]) && (r[l] = null),
                            (b.event.triggered = v),
                            t.isPropagationStopped() && p.addEventListener(v, mt),
                            r[v](),
                            t.isPropagationStopped() && p.removeEventListener(v, mt),
    ...
    (Rt.href = vt.href),
        b.extend({
            ...
            ajax: function (t, n) {
                ...
                if (
                    (m.promise(T),
                    (p.url = ((t || p.url || vt.href) + "").replace(Dt, vt.protocol + "//")),
                ...
                if (
                    ...
                    return T;
                for (f in ((c = b.event && p.global) && 0 == b.active++ && b.event.trigger("ajaxStart"),
                ...
                p.hasContent
                    ...
                    : ((d = p.url.slice(o.length)),
                      ...
                      !1 === p.cache &&
                          ((o = o.replace(kt, "$1")), (d = (bt.test(o) ? "&" : "?") + "_=" + xt.guid++ + d)),
                      (p.url = o + d)),
                p.ifModified &&
                    (b.lastModified[o] && T.setRequestHeader("If-Modified-Since", b.lastModified[o]),
                ...
                function q(t, n, a, u) {
                    ...
                    l ||
                        ...
                        f
                            ? (p.ifModified &&
                                  ((S = T.getResponseHeader("Last-Modified")) && (b.lastModified[o] = S),
                                  (S = T.getResponseHeader("etag")) && (b.etag[o] = S)),
                              204 === t || "HEAD" === p.type
                                  ? (j = "nocontent")
                                  : 304 === t
                                    ? (j = "notmodified")
                                    : ((j = w.state), (d = w.data), (f = !(y = w.error))))
                            : ((y = j), (!t && j) || ((j = "error"), t < 0 && (t = 0))),
                        (T.status = t),
                        (T.statusText = (n || j) + ""),
                        f ? m.resolveWith(h, [d, j, T]) : m.rejectWith(h, [T, j, y]),
                        T.statusCode(x),
                        (x = void 0),
                        c && g.trigger(f ? "ajaxSuccess" : "ajaxError", [T, p, f ? d : y]),
                        v.fireWith(h, [T, j]),
                        c && (g.trigger("ajaxComplete", [T, p]), --b.active || b.event.trigger("ajaxStop")));
                }
                return T;
            },
        ...
        b.each(["get", "post"], function (e, t) {
            b[t] = function (e, n, r, o) {
                return (
                    ...
                    b.ajax(b.extend({ url: e, type: t, dataType: o, data: n, success: r }, b.isPlainObject(e) && e))
                );
            };
        }),
    ...
    b.ajaxSetup({
            ...
            if (s || "jsonp" === t.dataTypes[0])
                return (
                    ...
                    s
                        ...
                        : !1 !== t.jsonp && (t.url += (bt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o),
        ...
        (p.createHTMLDocument =
            (((_t = y.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"),
        ...
        (b.parseHTML = function (e, t, n) {
            return "string" != typeof e
                ...
                : ("boolean" == typeof t && ((n = t), (t = !1)),
                  ...
                  o
                      ? [t.createElement(o[1])]
                      : ((o = xe([e], t, i)), i && i.length && b(i).remove(), b.merge([], o.childNodes)));
            var r, o, i;
        }),
...
var FuzzySet = (function () {
    ...
    return function (e, t, n, r) {
        ...
        (e = e || []),
            (o.gramSizeLower = n || 2),
            (o.gramSizeUpper = r || 3),
            (o.useLevenshtein = "boolean" != typeof t || t),
            (o.exactSet = {}),
            (o.matchDict = {}),
            (o.items = {});
        var i = function (e, t) {
        ...
        (o.get = function (e, t, n) {
            ...
            (o._add = function (e, t) {
                ...
                for (i in u)
                    (a = u[i]),
                        (l += Math.pow(a, 2)),
                        i in this.matchDict ? this.matchDict[i].push([o, a]) : (this.matchDict[i] = [[o, a]]);
                var c = Math.sqrt(l);
...
(jqSecurly = jQuery.noConflict(!0)),
    (function (e) {
        let t,
            n,
            r = chrome.runtime.connect({ name: "think_twice" }),
            o = 0.9,
            i = [],
            a = [],
            s = [],
        ...
        function g(e) {
            ...
            for (o = 0, i = e.length; o < i; o++) {
                ...
                a.length > 0 && (!s.length > 0 || s.text().length <= 1) && a.hide(),
                    "childList" === r.type &&
                        (r.addedNodes.length &&
                            Array.prototype.forEach.call(r.addedNodes, function (e) {
        ...
        function v(e) {
            for (var t = 0; t < e.length; t++) {
                ...
                if (
                    n &&
                    n.length > 0 &&
                    (-1 != n.toLowerCase().indexOf("search") || -1 != n.toLowerCase().indexOf("location"))
                )
                    return;
        ...
        function b(e, t, n) {
            let r = (function (e, t) {
                ...
                return (
                    n.setAttribute("id", r),
                    n.setAttribute("class", "tt-wrapper-parent"),
                    n.setAttribute("data-tt-typed-string", window.btoa(e)),
                    n.setAttribute("data-tt-matched-phrase", window.btoa(t)),
                    (n.innerHTML =
                        '<div class="tt-wrapper-loc"><div class="tt-wrapper"><img class="tt-warning" src="' +
                        chrome.runtime.getURL("tt-alert.svg") +
                        '"><div class="tt-tooltip"><span class="tt-header">Is this hurtful?</span></br><span class="tt-text">This message may contain hurtful language. Are you sure you want to send this message?</span></div></div></div>'),
                    { id: r, element: n }
                );
            })(t, n);
            ...
            o.setAttribute("id", "sh-" + r.id),
                "static" == jqSecurly(e.target).parent().css("position") &&
                    jqSecurly(e.target).parent().css({ position: "relative" }),
                jqSecurly(e.target).parent().find("securly-extension").length > 0 &&
                    jqSecurly(e.target).parent().find("securly-extension").hide(),
            ...
            i.appendChild(
                ...
                jqSecurly(i)
                    .find(".tt-wrapper-loc")
                    .width(jqSecurly(e.target).innerWidth() - 7),
            ...
            jqSecurly(i).find(".tt-wrapper-parent").css({ top: a.top, left: a.left });
                ...
                new ResizeObserver((e) => {
                    for (let t of e)
                        setTimeout(function () {
                            ...
                            e.find(".tt-wrapper-parent").css({ top: n.top, left: n.left });
        ...
        function w(e) {
            jqSecurly(e.target).hasClass("tt-detected") &&
                !jqSecurly(e.target).hasClass("tt-changed") &&
                (jqSecurly(e.target).addClass("tt-changed"),
                jqSecurly("#sh-" + jqSecurly(e.target).data("tt-id")).css({ display: "none" }));
        }
        function S(e) {
            jqSecurly(e.currentTarget).hasClass("tt-success-tracked") ||
                (jqSecurly(e.currentTarget).addClass("tt-success-tracked"),
                h(
                    jqSecurly(e.currentTarget).parents(".tt-wrapper-parent").attr("id"),
                    E(document.domain),
                    "CLICKED_WARNING",
                    window.atob(jqSecurly(e.currentTarget).parents(".tt-wrapper-parent").data("tt-typed-string")),
                    window.atob(jqSecurly(e.currentTarget).parents(".tt-wrapper-parent").data("tt-matched-phrase"))
                ));
        }
        function j(t) {
            if (!l) return;
            ...
            if (
                (n.length <= 1 && C(t),
                f
                    ? jqSecurly(t.target).hasClass("tt-detected") &&
                      (13 != t.keyCode || t.shiftKey ? T(t, n) : (q(jqSecurly(t.target).data("tt-id")), C(t)))
                    : d
                      ? jqSecurly(t.target).hasClass("tt-detected") &&
                        (!(function (e) {
                            ...
                            t &&
                                t.length > 0 &&
                                (jqSecurly(t[0]).hasClass("tt-event-added") ||
                                    (jqSecurly(t[0]).click(function (e) {
                                    ...
                                    jqSecurly(t[0]).addClass("tt-event-added"),
                                    jqSecurly(t[0]).data("tt-button-id", jqSecurly(e.target).data("tt-id"))));
                        })(t),
                        T(t, n))
                      : p &&
                        jqSecurly(t.target).hasClass("tt-detected") &&
                        (13 != t.keyCode || t.shiftKey || (q(jqSecurly(t.target).data("tt-id")), C(t)),
                        (function (t) {
                            ...
                            n &&
                                n.length > 0 &&
                                (jqSecurly(n[0]).hasClass("tt-event-added") ||
                                    (jqSecurly(n[0]).click(function (e) {
                                        let t = jqSecurly(e.currentTarget).data("tt-button-id");
                                        q(t),
                                            jqSecurly("#sh-" + t).remove(),
                                            jqSecurly(e.currentTarget).removeClass("tt-event-added"),
                                            jqSecurly(
                                                jqSecurly(e.currentTarget).parents("form").find(".tt-detected")[0]
                                            ).removeClass("tt-detected"),
                                            jqSecurly(
                                                jqSecurly(e.currentTarget).parents("form").find(".tt-changed")[0]
                                            ).removeClass("tt-changed");
                                    }),
                                    jqSecurly(n[0]).addClass("tt-event-added"),
                                    jqSecurly(n[0]).data("tt-button-id", jqSecurly(t.target).data("tt-id"))));
                        })(t),
                        T(t, n)),
                c)
            ) {
            ...
            if (
                ...
                s.length >= 1 &&
                    (jqSecurly(t.target).hasClass("tt-detected") && (r = !0),
                    jqSecurly(t.target).hasClass("tt-changed") && jqSecurly(t.target).removeClass("tt-changed"),
                    r ||
                        ((elementObj = b(t, n, s[0][0])),
                        h(elementObj.id, E(document.domain), "SHOW_WARNING", n, s[0][0]),
                        jqSecurly(jqSecurly("#sh-" + elementObj.id)[0].shadowRoot)
                            ...
                            .click(function (e) {
                                ...
                                jqSecurly(document).width(),
                                    jqSecurly(".tt-doc-tooltip-parent").css({ opacity: 1, display: "block" }),
                        ...
                        jqSecurly(jqSecurly("#sh-" + elementObj.id)[0].shadowRoot)
                            ...
                            .hover(
                                ...
                                function (e) {
                                    jqSecurly(".tt-doc-tooltip-parent").css({ opacity: 0, display: "none" });
                                }
                            )),
                    jqSecurly("#sh-" + jqSecurly(t.target).data("tt-id")).css({ display: "inherit" }),
                    (i = !0)),
                i)
            )
                return;
            ...
            u &&
                ...
                jqSecurly(t.target).hasClass("tt-changed") && jqSecurly(t.target).removeClass("tt-changed"),
                r ||
                    ((elementObj = b(t, n, u[0][1])),
                    h(elementObj.id, E(document.domain), "SHOW_WARNING", n, u[0][1]),
                    jqSecurly(jqSecurly("#sh-" + elementObj.id)[0].shadowRoot)
                        .find(".tt-wrapper")
                        .click(function (e) {
                            jqSecurly(document).width() < 350 && jqSecurly(".tt-doc-tooltip-parent").width(200);
        ...
        function T(e, t) {
            jqSecurly(jqSecurly("#sh-" + jqSecurly(e.target).data("tt-id"))[0].shadowRoot)
        ...
        function q(e) {
            try {
                let t = window.atob(
                    jqSecurly(jqSecurly("#sh-" + e)[0].shadowRoot)
                        .find(".tt-wrapper-parent")
            ...
            if (
                ...
                u.find((t) => t === e) &&
                    ...
                    (function () {
                        ...
                        ["discord.com", "pinterest.com", "in.pinterest.com", "pinterest.co.uk", "instagram.com"].find(
                            (e) => e === n
                        ) &&
                            ("discord.com" == (r = n)
                                ? (f = !0)
                                : -1 != r.indexOf("pinterest.co")
                                  ? (d = !0)
                                  : "instagram.com" == r && (p = !0));
                        var r;
                    })(),
